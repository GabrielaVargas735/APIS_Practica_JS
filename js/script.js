...
fetch('https://js2-tareas-api.netlify.app/api/tareas?uid=25')
...
fetch('https://js2-tareas-api.netlify.app/api/tareas?uid=25', fetchOption)
.then((response) => response.json())
.then((data) =>{
  console.log(data)
  appendTaskDOM(data);
...
function taskStatus(id, complete) {
  ...
  fetch('https://js2-tareas-api.netlify.app/api/tareas?uid=25', add)
  .then((response) => response.json())
  .then((data) =>{
    console.log(data)
    taskStatus(data)
...
function deleteTask(id) {
  ...
  fetch('https://js2-tareas-api.netlify.app/api/tareas?uid=25', delet)
  .then((response) => response.json())
  .then((data) =>{
    console.log(data)
    deleteTask(data)
